...
1. **Resize document** to the size recommended by the conference or A0. This way, even though the poster might be proportional to A4, you can use the real size fonts. 
