...
[Marianna Foos](https://twitter.com/MariannaFoos) pointed out another great R-package dealing with SNP annotation called [`rsnps`](https://cran.r-project.org/web/packages/rsnps/vignettes/rsnps_vignette.html). 
