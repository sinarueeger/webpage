...
```{r, sketch, echo=FALSE, fig.height = 5}
# From https://jackolney.github.io/blog/post/2016-08-15-ggplot2-font/
...
font_add_google(name = "Caveat", family = "Caveat", regular.wt = 400, bold.wt = 700)
    ...
    ggOut <- ggOut + theme(text = element_text(family = "Caveat"))
    ggOut
...
<figcaption><small>In this case, we want to visualise the GWAS P-value (-log10(P)) of a genomic region (with each point representing a SNP), with the corresponding genes at the bottom. This is similar to a plot done with [LocusZoom](http://locuszoom.org/), a tool that takes summary statistics as input and outputs a pretty graph for a desired genomic region, including gene annotation, LD information and more.
</small></figcaption>
</figure>
...
ggman::ggman(dat.bmi, snp = "SNP", bp = "POS", chrom = "CHR", pvalue = "P", lineColour = "black", clumps.colour = "black")
